...
class Home extends Component {
    ...
    create_list(){
        ...
        button_append.addEventListener("click", event => { this.add_to_end(); });
        button_before.addEventListener("click", event => { this.add_to_beginning(); });
        button_remove.addEventListener("click", event => { this.remove_from_end(); });
        button_submit.addEventListener("click", event => { this.submit_list(); });
        button_reset.addEventListener("click", event => { this.reset_list(); });
    }
add_to_end()
{
...
pressed_enter = (event) => {
        ...
        return (
            <div className="container-fluid">
                <section className= "top">
                    <section className= "welcome">
                        ...
                        <div className="text_on_image">Welcome to <br/>movies and tv series <br/> 
                                                        recommendations!</div> 

                            <div className="text_welcome"><br />Hi! We are computer science students who love watching movies and series 
                                in their free time. <br /> We decided to share with you our opinions on what we just watched. 
                                <br />Stay tuned and be sure to let us know what you think!</div>
                ...
                <section className= "wish_list">
                    <div className="wish_list" id="wish_list">
                        ...
                        <p>Make a list of movies and series that you want us to review in the future</p>
                        <button onClick={this.create_btn} type="button" id="create_btn">Create</button>
                        <div className="w_list" id="w_list" ref={this.div_list}>
                            <div className="border_l" id="border_l">
                                <ul id="my_list">
                                </ul>
                            </div>
                            <p><label>Your proposition:</label>
                                <br />
                                <input type="text" id="input_list" onKeyDown={this.pressed_enter} />
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <div id="float">
                    <div id="mail-div">
                        <p>
                        Maybe you want to recommend a movie or series to us? Write to us!
                        <p><a href="mailto:254520@student.pwr.edu.pl">
                            <img src="http://ppp5.pl/wp-content/uploads/2017/03/email-icon-23-300x300.png" width="30" height="30"
                                alt="Email" id="index_transition"/> </a></p>
                    </p>  
                    </div>
                    <div id="form_index">
                        <form>
                            ...
                            <p>
                                <button onClick={this.showAlert} id="send_btn">Send</button>
                            </p>
                        </form>
                    </div>
                </div>
            ...
            <p>
                <section class= "watch_on_average">
                    <div class="avg_watch">
                        <p><strong>Do you want to know how you compare to the average adult in the number of hours spent watching TV?</strong></p>
                        <button onClick={this.check_avg} type="button" id="avg_btn">Check</button>
                        <p id="result"></p>
                    </div>
                </section>
            </p>
    ...
    showAlert=()=> {
     ...
     check_avg=()=> {
        ...
        if(num > 4)
        {
            document.getElementById("result").innerHTML ="You spend more time watching TV than the average adult!";
        }
        else if(num === 4)
        {
            document.getElementById("result").innerHTML ="You spend exactly as much time watching TV as the average adult does";
        }
        else if(num < 4){
            document.getElementById("result").innerHTML ="You spend less time watching TV than the average adult";
        }
        else{
